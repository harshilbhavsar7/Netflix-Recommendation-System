...
tv_genre_dict = [{"id": 10759,"name": "Action & Adventure"},
...
for test_dict in tv_genre_dict:
	genre_id = test_dict['id']
	genre_name = test_dict['name']

	final_tv_genre_dict[genre_id] =genre_name 




# print(final_genre_dict)
# print(final_tv_genre_dict)

# print((final_tv_genre_dict.update(final_genre_dict)))
print({**final_genre_dict,**final_tv_genre_dict})
